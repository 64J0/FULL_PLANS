...
exports.genExcelFile = async (id) => {
    ...
    .then(function(workBook) {
        ...
        */
        var C41 = workBook.worksheets[0].getCell('C41').value;
        workBook.worksheets[0].getCell('C41').value = '';
        var H41 = workBook.worksheets[0].getCell('H41').value;
        workBook.worksheets[0].getCell('H41').value = '';
        var C44 = workBook.worksheets[0].getCell('C44').value;
        workBook.worksheets[0].getCell('C44').value = '';
        var D44 = workBook.worksheets[0].getCell('D44').value;
        workBook.worksheets[0].getCell('D44').value = '';
        var E44 = workBook.worksheets[0].getCell('E44').value;
        workBook.worksheets[0].getCell('E44').value = '';
        var C46 = workBook.worksheets[0].getCell('C46').value;
        ...
        */
        var salto = (res.infoProjetos.length + 34 + 2);
        workBook.worksheets[0].getCell(`C${salto}`).value = C41;
        workBook.worksheets[0].getCell(`C${salto}`).alignment = { vertical: 'middle', horizontal: 'left' }
