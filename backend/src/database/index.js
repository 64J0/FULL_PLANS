...
// Este módulo carrega variáveis de ambiente de um arquivo nomeado .env para
// um arquivo nomeado process.env.
// Armazenar algumas configurações sensíveis ou secretas em um ambiente separado,
...
module.exports = function db_Connection() {
  ...
  // Em seguida recuperamos a instância do mongoose para podermos manipular o que acontece
  // em alguns momentos, como na hora da conexão com o banco de dados (connected), quando a
  // conexão apresenta erro (error), ao desconectar (disconnected) e quando o usuário matar
  // o processo do Node.js (SIGINT)
